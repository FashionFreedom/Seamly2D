...
Section "Seamly2D"
  ...
  File /nonfatal "vc_redist.arm64.exe"

  IfFileExists $INSTDIR\vc_redist.x64.exe 0 vc_redist_arm64
  ExecWait '"$INSTDIR\vc_redist.x64.exe" /quiet /norestart'
  goto after_vc_redist ;
  vc_redist_arm64:
  IfFileExists $INSTDIR\vc_redist.arm64.exe 0 after_vc_redist
  ExecWait '"$INSTDIR\vc_redist.arm64.exe" /quiet /norestart'
  after_vc_redist:
