...
const QString AttrExtendStartPoint = QStringLiteral("extendStartPoint");
const QString AttrExtendEndPoint   = QStringLiteral("extendEndPoint");
...
const QString AttrLineId      = QStringLiteral("lineId");
const QString AttrLine1Id     = QStringLiteral("line1Id");
const QString AttrLine2Id     = QStringLiteral("line2Id");
const QString AttrLine3Id     = QStringLiteral("line3Id");
const QString AttrLine4Id     = QStringLiteral("line4Id");
