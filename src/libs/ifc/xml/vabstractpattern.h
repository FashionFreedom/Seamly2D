...
public:
    ...
    static VPiecePath              ParsePieceNodes(const QDomElement &domElement,
                                                    const QHash<QString, QString> &id_token_to_name);
...
protected:
    ...
    static VPiecePath ParsePathNodes(const QDomElement &domElement, const QHash<QString, QString> &id_token_to_name);
    static VPieceNode ParseSANode(const QDomElement &domElement, const QHash<QString, QString> &id_token_to_name);
