...
void SavePieceOptions::undo()
{
    ...
    if (domElement.isElement())
    {
        ...
        VToolSeamAllowance::addAnchors(doc, domElement, m_oldDet.getAnchors());
        ...
        IncrementReferences(m_oldDet.missingAnchors(m_newDet));
...
void SavePieceOptions::redo()
{
    ...
    if (domElement.isElement())
    {
        ...
        VToolSeamAllowance::addAnchors(doc, domElement, m_newDet.getAnchors());
        ...
        DecrementReferences(m_oldDet.missingAnchors(m_newDet));
