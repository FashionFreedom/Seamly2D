...
DeleteGroupItemUndoCmd::DeleteGroupItemUndoCmd(const QDomElement &xml, VAbstractPattern *doc, quint32 groupId, QUndoCommand *parent)
...
//---------------------------------------------------------------------------------------------------------------------
DeleteGroupItemUndoCmd::~DeleteGroupItemUndoCmd()
{
}

//---------------------------------------------------------------------------------------------------------------------
void DeleteGroupItemUndoCmd::undo()
{
...
//---------------------------------------------------------------------------------------------------------------------
void DeleteGroupItemUndoCmd::redo()
{
