...
public:
    ...
    static VToolAlongLine *Create(const quint32 _id, const QString &pointName, const QString &typeLine,
                                  ...
                                  quint32 secondPointId, quint32 line1_id, quint32 line2_id, qreal mx, qreal my,
                                  bool showPointName,
...
private:
    ...
    quint32              m_line1_id; /** @brief m_line1_id persisted id of the first-to-point line. See issue #1678. */
    quint32              m_line2_id; /** @brief m_line2_id persisted id of the point-to-second line. See issue #1678. */

                         VToolAlongLine(VAbstractPattern *doc, VContainer *data, quint32 id, const QString &formula,
                                        const quint32 &firstPointId, const quint32 &secondPointId,
                                        const quint32 &line1_id, const quint32 &line2_id,
