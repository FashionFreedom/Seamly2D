...
public:
    ...
    static VToolShoulderPoint *Create(const quint32 _id, QString &formula, quint32 p1Line, quint32 p2Line,
                                      ...
                                      const QString &pointName, quint32 line1_id, quint32 line2_id, qreal mx, qreal my,
                                      bool showPointName,
...
private:
    ...
    quint32                    m_line1_id; /** @brief m_line1_id persisted id of the p1Line-to-point line. See issue #1678. */
    quint32                    m_line2_id; /** @brief m_line2_id persisted id of the p2Line-to-point line. See issue #1678. */
    ...
    VToolShoulderPoint(VAbstractPattern *doc, VContainer *data, const quint32 &id, const QString &typeLine,
                       ...
                       const quint32 &pShoulder, const quint32 &line1_id, const quint32 &line2_id,
