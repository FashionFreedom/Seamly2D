...
public:
    ...
    static VToolHeight  *Create(const quint32 _id, const QString &pointName, const QString &lineType,
                                ...
                                quint32 p2LineId, quint32 line1_id, quint32 line2_id, quint32 line3_id,
...
private:
    ...
    quint32              m_line2_id; /** @brief m_line2_id persisted id of the p1Line-to-point line. See issue #1678. */
    quint32              m_line3_id; /** @brief m_line3_id persisted id of the p2Line-to-point line. See issue #1678. */
