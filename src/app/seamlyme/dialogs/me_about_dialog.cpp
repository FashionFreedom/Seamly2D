...
#include "me_about_dialog.h"
#include "ui_me_about_dialog.h"
#include "../version.h"
#include "../vmisc/def.h"
...
//---------------------------------------------------------------------------------------------------------------------
MeAboutDialog::MeAboutDialog(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::MeAboutDialog)
    , isInitialized(false)
{
    ui->setupUi(this);
    ...
    connect(ui->buttonBox, &QDialogButtonBox::accepted, this, &MeAboutDialog::close);
...
//---------------------------------------------------------------------------------------------------------------------
MeAboutDialog::~MeAboutDialog()
{
    delete ui;
}

//---------------------------------------------------------------------------------------------------------------------
void MeAboutDialog::showEvent(QShowEvent *event)
{
